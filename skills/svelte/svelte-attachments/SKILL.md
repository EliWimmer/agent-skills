---
name: svelte-attachments
description: >
  Instructions for using the Svelte 5 attachments system `{@attach}` and how to use it effectively. Use when implementing or refactoring components that use attachments, `{@attach ...}` or `use:...`, or when the user mentions svelte attachments.
paths:
  - "**/*.svelte"
  - "**/*.svelte.**"
---
