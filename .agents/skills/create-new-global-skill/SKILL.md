---
name: create-new-global-skill
description: Documents how to author and deprecate skills in this repository's global catalog. Use when creating, renaming, or retiring a skill under skills/.
disable-model-invocation: true
---

# Authoring the global skill catalog
...
- **Category folders** (e.g. `engineering/`, `meta/`) are for navigation only; install flattens to `<skill-name>/` in each tool directory.
