...
Fix the user-provided issue(s). Load project documentation first, align with canonical domain language, implement a focused fix, and grill only when ambiguity or contradictions need clarification.
